...
--
-- Host: localhost    Database: cudecaclarke
-- ------------------------------------------------------
...
INSERT INTO `entrada` VALUES (1,1,25,300,'Datos.Entrada general'),(2,1,45,80,'Datos.Entrada VIP'),(3,1,60,20,'Zona palco'),(4,2,10,500,'Inscripción básica'),(5,2,20,150,'Inscripción premium'),(6,3,2,1000,'Participación simple'),(7,3,5,400,'Pack de 3 participaciones'),(8,4,8,200,'Datos.Entrada general'),(9,4,15,100,'Acceso completo'),(10,5,30,250,'Datos.Entrada general'),(11,5,55,60,'VIP primera fila'),(12,6,12,400,'Inscripción básica'),(13,6,25,160,'Inscripción avanzada'),(14,7,1.5,1200,'Rifa estándar'),(15,7,4,500,'Pack especial'),(16,8,18,80,'Taller básico'),(17,8,30,40,'Taller avanzado'),(18,9,20,500,'Datos.Entrada general'),(19,9,35,120,'Datos.Entrada preferente'),(20,10,15,350,'Inscripción general'),(21,10,30,100,'Inscripción elite'),(22,11,3,700,'Boleto navideño'),(23,11,7,250,'Pack navidad'),(24,13,22,200,'Datos.Entrada normal'),(25,13,40,80,'VIP'),(26,16,5,300,'Acceso general'),(27,16,12,100,'Acceso completo'),(28,17,28,180,'Datos.Entrada general'),(29,17,50,50,'VIP'),(30,17,70,15,'Zona premium');
